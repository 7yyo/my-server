...
public class HandshakeV10Packet extends MySQLPacket {
    ...
    // lower 2 bytes of the Protocol::CapabilityFlags (optional)
    // default server character-set, only the lower 8-bits Protocol::CharacterSet
    ...
    private int authPluginDataLen; // length of the combined auth_plugin_data, if auth_plugin_data_len is > 0
